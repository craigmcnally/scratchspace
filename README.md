...
1. Place a copy of the [PERSONAL_DATA_DISCLOSURE.md](PERSONAL_DATA_DISCLOSURE_FORM.md) at the top level of your module's git repository, e.g. next to `README.md`, `NEWS.md`, etc.
